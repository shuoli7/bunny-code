...
# Output
# Integer, which represents the length of new list after deleting all numbers of the input value.
...
# Then We get the sliced list up to position j and return the length of sliced list.
